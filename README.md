...
# Bootcamp PipeLine
1. Fork the [AISSE Arduino Bootcamp](https://github.com/ren-1ee/AISSE_Arduino_Bootcamp) to a repo called `2026SE-Arduino-Bootcamp.Ben.Jones` (the year is the year you graduate, and the name is your name)
